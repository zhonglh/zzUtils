 ...
 */
package com.zz.bms.util.poi.excel.export.base;
...
import com.zz.bms.util.poi.util.PoiMergeCellUtil;
        ...
        for (int k = indexKey, paramSize = excelParams.size(); k < paramSize; k++) {
            ...
            if (entity.getList() != null) {
                ...
                if(list == null) {  
                	...
                	try{
                	Class<?> declaringClass = entity.getList().get(0).getMethod().getDeclaringClass();
                		createListCells(patriarch, index + listC, cellNum, declaringClass.newInstance() , entity.getList(),
                                sheet, workbook);
                	}catch(Exception e){
                		e.printStackTrace();
                	}
