 ...
 */
package com.zz.bms.util.poi.export.excel.imports;
...
import com.zz.bms.util.poi.export.excel.annotation.ExcelTarget;
...
import com.zz.bms.util.poi.export.excel.entity.result.ExcelImportResult;
import com.zz.bms.util.poi.export.excel.entity.result.ExcelVerifyHanlderResult;
import com.zz.bms.util.poi.export.excel.imports.base.ImportBaseService;
import com.zz.bms.util.poi.export.excel.imports.verifys.VerifyHandlerServer;
import com.zz.bms.util.poi.exception.excel.ExcelImportException;
import com.zz.bms.util.poi.exception.excel.enums.ExcelImportEnum;
...
public class ExcelImportServer extends ImportBaseService {
    ...
    public ExcelImportResult importExcelByIs(InputStream inputstream, Class<?> pojoClass,
        ...
        if(params.getMaps()!=null){
        	ThreadLocalHolder.setDynamicMap(params.getMaps());
        }
