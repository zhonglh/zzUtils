 ...
 */
package com.zz.bms.util.poi.export.excel.entity;

import org.apache.poi.hssf.util.HSSFColor;
import com.zz.bms.util.poi.export.excel.entity.enmus.ExcelType;
import com.zz.bms.util.poi.export.excel.export.styler.ExcelExportStylerColorImpl;
...
public class ExportParams extends ExcelBaseParams {
     ...
     * 表头颜色
     */
    private short     color             = HSSFColor.GREY_25_PERCENT.index;
    /**
     * 属性说明行的颜色 例如:HSSFColor.SKY_BLUE.index 默认
     */
    private short     headerColor       = 41;
    /**
     * Excel 导出版本
     */
     ...
     * Excel 导出style
     */
    private Class<?>  style             = ExcelExportStylerColorImpl.class;
    /**
     * 是否创建表头
     */
