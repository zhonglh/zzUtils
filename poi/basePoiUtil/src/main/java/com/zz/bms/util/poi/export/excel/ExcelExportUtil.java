...
import com.zz.bms.util.poi.export.excel.export.ExcelExportServer;
import com.zz.bms.util.poi.export.excel.export.template.ExcelExportOfTemplateUtil;
...
public final class ExcelExportUtil {
    ...
    public static Workbook exportExcel(List<Map<String, Object>> list, String type) {
        Workbook workbook;
        if (ExcelType.HSSF.name().equals(type)) {
            workbook = new HSSFWorkbook();
        } else {
            workbook = new XSSFWorkbook();
        }
