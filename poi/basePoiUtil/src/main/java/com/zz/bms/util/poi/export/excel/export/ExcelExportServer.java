 ...
 */
package com.zz.bms.util.poi.export.excel.export;
...
import com.zz.bms.util.poi.export.excel.entity.ExportParams;
import com.zz.bms.util.poi.export.excel.entity.enmus.ExcelType;
import com.zz.bms.util.poi.export.excel.entity.params.ExcelExportEntity;
import com.zz.bms.util.poi.export.excel.entity.vo.PoiBaseConstants;
import com.zz.bms.util.poi.export.excel.export.base.ExcelExportBase;
import com.zz.bms.util.poi.export.excel.export.styler.IExcelExportStyler;
import com.zz.bms.util.poi.exception.excel.ExcelExportException;
import com.zz.bms.util.poi.exception.excel.enums.ExcelExportEnum;
    ...
    private int createTitleRow(ExportParams title, Sheet sheet, Workbook workbook, int index,
        ...
        for (int i = 0, exportFieldTitleSize = excelParams.size(); i < exportFieldTitleSize; i++) {
            ...
            if (entity.getList() != null) {
                ...
                for(int listcellIndex = 1; listcellIndex < sTitel.size(); listcellIndex ++ ){
                	createStringCell( row, cellIndex+listcellIndex, "", titleStyle, entity);
                }
                if (StringUtils.isNotBlank(entity.getName())) {
