package com.zz.bms.util.base.sun;
...
public class Base64 {
    ...
    public static final BigInteger decodeBigIntegerFromElement(Element element)
            throws Base64DecodingException {
        return new BigInteger(1, com.sun.org.apache.xml.internal.security.utils.Base64.decode(element));
    }
    ...
    public static final BigInteger decodeBigIntegerFromText(Text text)
            throws Base64DecodingException {
        return new BigInteger(1, com.sun.org.apache.xml.internal.security.utils.Base64.decode(text.getData()));
    }
