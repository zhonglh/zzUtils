...
public class CronExpressionEx  extends CronExpression{
    ...
    private String secondsExp;                              // 秒钟
    private String minutesExp;                              // 分钟
    private String hoursExp;                                // 小时
    private String monthsExp;                               // 月
    private String daysOfWeekExp;                           // 星期
    private String daysOfMonthExp;                          // 日或者天
