...
public class SendMailUtil
{
	...
	public static void loadEmailInfo(){
		try {
			...
			if(mailConfig != null){
				SendMailUtil.from = MailConfig.getSender();
				SendMailUtil.fromName = MailConfig.getSenderName();
				SendMailUtil.username  = MailConfig.getUser();
				SendMailUtil.password = MailConfig.getPwd();
				SendMailUtil.host = MailConfig.getSmtpHost();
			}
		}catch (Exception e ){
