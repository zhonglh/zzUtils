/**
 * copy with  org.springframework.util.ReflectionUtils
 */
...
public abstract class ReflectionUtils {
    ...
    public static void doWithFields(Class<?> clazz,  FieldCallback fc) {
        doWithFields(clazz, Object.class, fc, (FieldFilter)null);
    }


    public static void doWithFields(Class<?> clazz, Class<?> stopClz,   FieldCallback fc) {
        doWithFields(clazz, stopClz, fc, (FieldFilter)null);
    }


    public static void doWithFields(Class<?> clazz, FieldCallback fc, @Nullable FieldFilter ff) {
        doWithFields(clazz, Object.class, fc, ff);
    }

    public static void doWithFields(Class<?> clazz, Class<?> stopClz, FieldCallback fc, @Nullable FieldFilter ff) {
        Class targetClass = clazz;
        if(stopClz == null){
            stopClz = Object.class;
        }
        do {
