...
public class StringUtil {
	...
	private static String jsNull = "undefined";
	private static String javaNull = "null";
	...
	public static boolean isEmpty(String s) {
		if (s == null || s.isEmpty() || jsNull.equalsIgnoreCase(s) || javaNull.equalsIgnoreCase(s)) {
			return true;
		}
		return false;
	}
	...
	public static String changCoding(String s) throws UnsupportedEncodingException {
	 ...
	 * @return
	 */
	public static String getRandomCode(int capacity) {
		...
		for (int i = 0; i < capacity; i++) {
			int code = secureRandom.nextInt( length - 1);
